...
export class DetalhesComponent extends SuperDetalhesComponent {
  ...
  constructor(protected service: ProdutoService, protected router: Router, protected route: ActivatedRoute,protected produtoService:ProdutoService,protected categoriaService:CategoriaService) {
